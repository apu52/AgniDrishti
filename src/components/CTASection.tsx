      ...
      <div className="container">
        <div className="max-w-5xl mx-auto text-center relative z-30">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-6 mb-12">
            <div className="bg-black/90 border border-fire/20 rounded-xl p-6 flex flex-col items-center text-center">
            ...
            <div className="bg-black/90 border-fire/20 rounded-xl p-6 flex flex-col items-center text-center">
              <div className="w-16 h-16 rounded-full bg-fire/10 flex items-center justify-center mb-4">
