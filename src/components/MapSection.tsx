...
const MapSection = () => {
  ...
  <div className="container relative z-10">
    ...
    <div className="grid grid-cols-1 lg:grid-cols-3 gap-8 items-start">
      {/* Map Container - Updated with layered borders */}
      <div className="lg:col-span-2">
        <div className="aspect-video md:aspect-[16/9] overflow-hidden rounded-xl relative 
                      border-4 border-black/80 
                      glow-border 
                      before:content-[''] before:absolute before:inset-0 before:rounded-xl before:border-2 before:border-fire/50 before:pointer-events-none">
          {loading ? (
