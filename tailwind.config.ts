...
export default {
  ...
  theme: {
    ...
    extend: {
      ...
      backgroundImage: {
        "gradient-fire":
          "linear-gradient(225deg, #1a1a1a 0%, #2d1a1a 50%, #331111 100%)",
        "gradient-fire-radial":
          "radial-gradient(circle, #331111 0%, #1a1a1a 100%)",
        "gradient-fire-sidebar":
          "linear-gradient(180deg, #1a1a1a 0%, #331111 100%)",
      },
    },
  },
